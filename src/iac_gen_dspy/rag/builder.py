...
def build_and_optimize_metadata_generator(self, 
train_examples: List[dspy.Example], 
eval_examples: List[dspy.Example] = None,
optimizer_output_path: str = "optimized_metadata_generator.json") -> MetadataGenerationModule:
"""
...
max_examples_for_kb: int = 10) -> None:
"""
...
# Load optimized metadata generator
...
# Build and optimize metadata generator
